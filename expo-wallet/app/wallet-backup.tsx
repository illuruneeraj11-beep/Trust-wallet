  ...
  return (
    <>
      ...
      <SheetModal visible={sheet === "backup"} title="Back up your wallet" subtitle="Choose how you want to protect this wallet." onClose={() => setSheet(null)}>
        ...
        <View style={{ borderRadius: 16, backgroundColor: "#fff7dd", padding: 14, flexDirection: "row", gap: 10 }}><TrustIcon color="#9a6800" name="shield-alert-outline" size={23} /><Text style={{ flex: 1, color: theme.secondary, fontSize: 13, lineHeight: 19 }}>Recovery phrase backup is unavailable for simulated wallets. This app will never ask you to enter an existing recovery phrase.</Text></View>
